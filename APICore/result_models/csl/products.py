...
def get_app_session_details_by_product_id(
    *,
    item: CSLProduct,
...
def get_all_app_session_details(
    *,
    objects: CSLProducts,
    start_date: str | None = None,
) -> CSLAppSessions:
    ...
    for item in objects.items:
        try:
            new_items = get_app_session_details_by_product_id(
                item=item,
                start_date=start_date,
            )
...
def get_all_product_app_sessions(
    *,
    objects: CSLProducts,
    start_date: str | None = None,
) -> CSLProducts:
    for product in objects.items:
        app_sessions = get_app_session_details_by_product_id(
            item=product, start_date=start_date
        )
