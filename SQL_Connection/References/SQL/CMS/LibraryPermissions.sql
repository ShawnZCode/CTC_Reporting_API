/****** Object:  Table [CMS].[LibraryPermissions]    Script Date: 11/17/2022 4:22:54 PM ******/
SET ANSI_NULLS ON

SET QUOTED_IDENTIFIER ON

CREATE TABLE [CMS].[LibraryPermissions](
...
ALTER TABLE [CMS].[LibraryPermissions] ADD  DEFAULT ((0)) FOR [resourceSource]
