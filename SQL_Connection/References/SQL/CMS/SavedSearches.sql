/****** Object:  Table [CMS].[SavedSearches]    Script Date: 11/17/2022 4:23:50 PM ******/
SET ANSI_NULLS ON

SET QUOTED_IDENTIFIER ON

CREATE TABLE [CMS].[SavedSearches](
...
ALTER TABLE [CMS].[SavedSearches] ADD  DEFAULT (CONVERT([bit],(0))) FOR [filterContentByNotTagged]
